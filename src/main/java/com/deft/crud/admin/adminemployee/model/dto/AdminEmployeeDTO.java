...
public class AdminEmployeeDTO {
	...
	public AdminEmployeeDTO(int employeeNo, String employeeName, String employeeId, String employeePwd, Date employeeBirth,
			String gender, String email, String address, String phone, String tel, String deptName, String jobName,
			String authority, int mangerNo, String fax, String entYn, Date hireDate, Date entDate) {
		super();
	...
	public String toString() {
		return "EmployeeDTO [employeeNo=" + employeeNo + ", employeeName=" + employeeName + ", employeeId=" + employeeId
				...
				+ fax + ", hireYn=" + entYn + ", hireDate=" + hireDate + ", entDate=" + entDate + "]";
	}
