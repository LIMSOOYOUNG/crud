...
public class BusinessServiceTests {
	...
	/*
	 * @Test public void testSelectBusinessChanceAll(@AuthenticationPrincipal
	 * UserImpl userInfo) {
	 * 
	 * List<BusinessChanceDTO> businessChanceList =
	 * businessService.selectBusinessChanceAll(userInfo);
	 * 
	 ...
	 * @Test
	 * 
	 * @Disabled public void testSelectActivityAll(@AuthenticationPrincipal UserImpl
	 * userInfo) {
	 * 
	 * List<BusinessActivityDTO> businessActivityList =
	 * businessService.selectActivityAll(userInfo);
	 * assertNotNull(businessActivityList); }
	 */
}
